(() => {
  ...
  if(!document.querySelector('.site-footer')&&!document.querySelector('.page-hero[style*="100vh"]')){
    document.body.insertAdjacentHTML('beforeend',`<footer class="footer site-footer"><div class="wrap footer-grid"><div class="footer-brand"><a class="brand brand-light" href="index.html"><span class="brand-mark">N/</span><span>NORTHLINE<small>CONSTRUCT</small></span></a><p>BUILDING WITH DISCIPLINE.<br>DELIVERING WITH CLARITY.</p><div class="socials"><a href="#" aria-label="LinkedIn">in</a><a href="#" aria-label="Instagram">â—Ž</a><a href="#" aria-label="Facebook">f</a></div></div><div><h2>Explore</h2><a href="index.html">Home</a><a href="about.html">About</a><a href="projects.html">Projects</a><a href="insights.html">Insights</a></div><div><h2>Capabilities</h2><a href="service-general-contracting.html">General contracting</a><a href="service-design-build.html">Design + build</a><a href="services.html#preconstruction">Preconstruction</a><a href="services.html#civil">Civil works</a></div><div><h2>Start a conversation</h2><p>Riverside Drive, Westlands<br>Nairobi, Kenya</p><a href="tel:+254709246800">+254 709 246 800</a><a href="mailto:hello@northline.co.ke">hello@northline.co.ke</a><p>Monâ€“Fri Â· 8:00â€“17:00</p></div></div><div class="wrap demo-note">This website is a DesignPhox demonstration created to showcase modern website design for Kenyan construction companies.</div><div class="wrap footer-base"><span>COPYRIGHT Â© <span data-year>${new Date().getFullYear()}</span>. NORTHLINE CONSTRUCT. DESIGN BY <b>DesignPhox.</b></span><span>NAIROBI Â· KENYA</span></div><a class="footer-help" href="quote.html"><span>N/</span> HOW CAN WE HELP?</a></footer>`);
  }
